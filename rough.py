...
root.title("Fast Food Hub")

Tops = Frame(root,bg="black",width = 1600,height=50,relief=RAISED)
Tops.pack(side=TOP)
...
######### information of top ####################
lblinfo = Label(Tops, font=( 'aria' ,30, 'bold' ),text="Fast Food Hub",fg="dark red",bd=10,anchor='w')
lblinfo.grid(row=0,column=0)
lblinfo = Label(Tops, font=( 'aria' ,20, ),text=localtime,fg="dark red",anchor=W)
